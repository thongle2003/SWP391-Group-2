              ...
              <div className="user-menu-container">
                ...
                {showUserMenu && (
                  <div className="user-dropdown">
                    <div className="dropdown-item" onClick={() => { const r = (user?.role?.roleName || user?.role || '').toString().toLowerCase(); if (r === 'admin' || r === 'administrator') { navigate('/admin'); } else { navigate('/user-profile'); } setShowUserMenu(false); }}>
